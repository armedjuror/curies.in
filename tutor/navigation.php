            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <li>
                    <a class="profile-pic" href="profile.php">
                        <?php
                        if ($user['profilepic']){
                            echo '<img width="36" class="img-circle" alt="user-img" src="data:image/jpeg;base64,'.base64_encode($user['profilepic']).'">';
                        }else{
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="students.php?id=0" class="waves-effect"><i class="fa fa-graduation-cap fa-fw" aria-hidden="true"></i>Students</a>
                </li>
                <li>
                    <a href="exams.php?id=0" class="waves-effect"><i class="fa fa-pencil-square fa-fw" aria-hidden="true"></i>Exams</a>
                </li>
                <li>
